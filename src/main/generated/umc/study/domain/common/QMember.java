...
public class QMember extends EntityPathBase<Member> {
    ...
    public final EnumPath<umc.study.domain.ENUM.Gender> gender = createEnum("gender", umc.study.domain.ENUM.Gender.class);
    ...
    public final EnumPath<umc.study.domain.ENUM.SocialType> socialType = createEnum("socialType", umc.study.domain.ENUM.SocialType.class);

    public final StringPath specAddress = createString("specAddress");

    public final EnumPath<umc.study.domain.ENUM.MemberStatus> status = createEnum("status", umc.study.domain.ENUM.MemberStatus.class);
