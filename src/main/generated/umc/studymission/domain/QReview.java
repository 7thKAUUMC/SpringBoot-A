...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = -317466662L;
    ...
    public final QReview replyToReview;
    ...
    public QReview(Class<? extends Review> type, PathMetadata metadata, PathInits inits) {
        ...
        this.replyToReview = inits.isInitialized("replyToReview") ? new QReview(forProperty("replyToReview"), inits.get("replyToReview")) : null;
